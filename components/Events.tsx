...
const Events = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      location: "Paris, France",
      attendees: "100",
      description: "Concluded one-day forum on the agentic transition — Agentic AI Systems, AI in Education, Trusted Agentic AI, and Open Token & Digital Public Goods. The Forum Report and Paris Initiative are now published.",
    ...
    },
    {
      ...
      location: "Shenzhen 2026",
      attendees: "100–150",
      description: "Centered on human agency in the age of agent-built software, the forum connects open source, mobile agentic OS, enterprise governance, and AI-native organizations. Invitation-only, under the Chatham House Rule.",
