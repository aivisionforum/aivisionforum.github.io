...
const Events = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      subtitle: "Robotics & AI Hardware",
      date: "OCTOBER 2026",
      location: "Shenzhen, China",
      attendees: "100-150",
      description: "The next chapter of the AI Vision Forum series — convening builders, foundation stewards, and policymakers on the robotics and AI-hardware frontiers. Invitation-only, Chatham House Rule.",
